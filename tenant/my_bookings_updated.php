...
$message = '';
if(isset($_GET['cancelled'])) $message = "Booking cancelled!";
                    ...
                    <tr>
                        ...
                        <td style="padding: 1rem; border: 1px solid #ddd;">
                            <?php if($row['status'] != 'accepted'): ?>
                                <a href="cancel_booking.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" style="padding: 0.5rem 1rem; font-size: 0.9rem; background-color: #e74c3c;" onclick="return confirm('Cancel booking?')">Cancel</a>
                            <?php else: ?>
                                <span>-</span>
                            <?php endif; ?>
                        </td>
